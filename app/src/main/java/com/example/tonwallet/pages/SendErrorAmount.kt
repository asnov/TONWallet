...
private const val TAG = "SendErrorAmount"
    ...
    Column(
        ...
        )
        {
            ...
            Column() {
                ...
                Column(Modifier.padding(bottom=31.dp),
                    Arrangement.Center,
                    Alignment.CenterHorizontally,) {
                    Row(
                        Modifier
                    ...
                    )
                    {
                        ...
                        BasicTextField(value = "57",
                            onValueChange = {},
                            Modifier.width(51.dp,), // here should be min width=26 expanding when enter more numbers
                            textStyle = TextStyle(
