...
private const val TAG = "PopupSureDelete"
...
fun PopupSureDelete(
    ...
    Column(
        ...
        Text(
            stringResource(R.string.account_will_be_removed),
            Modifier
//                .height(40.dp)
...
//            lineHeight = 2.sp,
        ...
        Row(
            ...
            Button(
                ...
                Text(
                    stringResource(R.string.no_cancel),
...
//                    .padding(end = 8.dp, bottom = 12.dp),
                ...
                Text(
                    stringResource(R.string.yes_remove_it),
                    color = Color(0xFF1A81CF),
                    fontFamily = Roboto,
                    fontWeight = FontWeight.W500,
                    fontSize = 14.sp,
